...
import { db } from "../db";
import { users, couples, invitations, oneTimeInvitations, supportRequests } from "../../shared/schema";
...
router.get("/data", async (_req, res) => {
  const [userRows, coupleRows, invitationRows, oneTimeRows, supportRows] = await Promise.all([
